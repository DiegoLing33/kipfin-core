...
public class FTPManager {
     ...
     */
    public static me.ling.core.FTPClient createClient(FTPClient connection){
        return new me.ling.core.FTPClient(connection);
    }
     ...
     * @return  - элемент клиента
     */
    public static me.ling.core.FTPClient createClient() throws IOException {
        return new me.ling.core.FTPClient(FTPManager.getConnection());
    }
}
